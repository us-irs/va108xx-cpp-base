...
/*__asm void HardFault_Handler(void)
{
  ...
  PRESERVE8
  MOVS    r3, #127
  PUSH    {r3-r7,lr}    ; Save contents of other registers for display (R3 included to meet
REQUIRE8)e MOV     R0,SP         ; Pass current SP as parameter BL      __cpp(C_HardFault_Handler)
