...
/*  CEM  commenting out this whole file due to undeclared constants causing errors
 *
...
//      VOR_IOCONFIG->PORTB[9] = 0x2000;      // Standard input, FuncSel=1 => UARTA_TX
  ...
  if (redirect_stdio_mode == STDIO_MODE_SPI2) {
                ...
                VOR_IOCONFIG->PORTB[14] = 0x4001;      // Standard input no-sync, FuncSel=2 =>
SPI_MOSIB VOR_IOCONFIG->PORTB[13] = 0x4000;      // Standard input, FuncSel=2 => SPI_MISOB
...
#endif
*
  end of entire file being commented out  */
